...
[Eric Wastl](http://was.tl/). These are my solutions in Swift. The template used is from [@swiftlang](https://github.com/swiftlang/swift-aoc-starter-example)'s [swift-aoc-starter-example](https://github.com/swiftlang/swift-aoc-starter-example).
